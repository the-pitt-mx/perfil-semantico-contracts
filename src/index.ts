...
/**
 * `GET /perfil/:clienteId` — lo que alimenta el hub del cliente.
 *
 * El hub es un **hub permanente y dinámico**, no una página estática (Modelo de
 * Negocio §3): muestra distinto contenido según el estado de compra. Por eso la
 * respuesta trae todo junto y es `web` quien decide qué renderizar, en vez de
 * exigir varias llamadas encadenadas.
 *
